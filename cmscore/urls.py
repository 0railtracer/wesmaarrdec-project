...
urlpatterns = [
    ...
    path('albumphotoimg/<str:pk>/', albumimgs, name='albumimgs'),
    path('createphoto/', createphoto, name='createphoto'),
    path('photoupdate/<int:albumphoto_id>/update/', photoupdate, name='photoupdate'),
    ...
    path('onprojects/<int:proj_id>/', onprojectdetail, name='onprojectdetail'),
